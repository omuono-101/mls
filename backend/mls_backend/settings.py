...
# PyMySQL as drop-in replacement for MySQLdb (works on shared hosting without gcc)
try:
    import pymysql
...
if database_url:
    try:
        ...
        if parsed_db:
            ...
            # Enable MySQL strict mode to suppress W002 warning
...
CSRF_TRUSTED_ORIGINS = [
    'https://lms.kisecollege.ac.ke',
    'https://kisecollege.ac.ke',
